// Seed/demo data used by the backend and local development. The live application reads data through DataContext and the REST API.
...
export const seedAssignments = [
  {
    ...
    oneDriveLink: "https://onedrive.live.com/redir?assignment=avl-trees",
